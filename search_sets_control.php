...
<div style="text-align:center;">
   <button class="iconButtons" type="button" id="searchNow_sets"><span class="glyphicon glyphicon-search" aria-hidden="true" style="font-size: 2.5em; color: white;"></span></button>
   <button class="iconButtons" type="button" id="onlyMine_sets" ><span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="font-size: 2.5em; color: #1ae466;"></span></button>
   <button class="iconButtons3" type="button" id="allCards_sets" style="display: none;"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true" style="font-size: 2.5em;"></span></button>
   <button class="iconButtons" type="button" id="notMine_sets" ><span class="glyphicon glyphicon-ban-circle" aria-hidden="true" style="font-size: 2.5em; color: #00afe5;"></span></button>
   <button class="iconButtons" type="button" id="searchStyle_sets" value="List_View"><span class="glyphicon glyphicon-th" aria-hidden="true" style="font-size: 2.5em; color: Gray;"></span></button>
   <button class="iconButtons" type="button" id="clearAll_sets" ><span class="glyphicon glyphicon-remove" aria-hidden="true" style="font-size: 2.5em; color: Tomato;"></span></button>
   <button class="iconButtons" type="button" id="xsmallShowOptions_sets" style="display: none;"><span class="glyphicon glyphicon-share-alt" aria-hidden="true" style="font-size: 2.5em; color: Lime;"></span></button>
</div>
...
echo '<ul class="list-group">';
   ...
   foreach($button_values_sets as $b_key => $b_value){
   ...
   foreach($complex_button_values_sets as $c_key => $c_value){
   ...
   <div class="col-lg-10 col-md-9 col-sm-8 hidden-xs gallery-padding" id="search-content" >
