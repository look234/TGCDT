...
$meta_tags = "dm, duelmasters, Duel Masters, checklist, database, card game, trading card, collectible card, TGCDT, The Giant Checklist Database Thing";
...
$master_query = "SELECT * FROM DM_SETS_" . $_SESSION['language'] ." INNER JOIN DM_CARDS ON DM_SETS_" . $_SESSION['language'] .".Card_ID = DM_CARDS.Card_ID WHERE ( ";
