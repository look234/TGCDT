...
if($_POST['add_cards_text'] == "add_cards_text"){
   echo '<br/><span>Text Language</span> <input type="text" size="10" id="Text_Language"></input><br/>';
...
if($_POST['search_attack_name'] == "search_attack_name_1"){
   ...
   $search_attack_name_query = "SELECT * FROM YGO_TEXT WHERE Card_Effect LIKE '%" . $_POST['Attack_Name'] . "%' OR Materials LIKE '%" . $_POST['Attack_Name'] . "%' OR Flavor_Text LIKE '" . $_POST['Attack_Name'] . "%' ORDER BY Card_Text_ID DESC";
...
if($_POST['add_cards_text_submit'] == "add_cards_text_submit"){
   $insert_query = "INSERT INTO YGO_TEXT (Text_Language, Flavor_Text, Materials, Pendulum_Effect, Card_Effect) VALUES ('" . mysql_real_escape_string($_POST['Text_Language']) . "','" . mysql_real_escape_string($_POST['Flavor_Text']) . "','" . mysql_real_escape_string($_POST['Materials']) . "','" . mysql_real_escape_string($_POST['Pendulum_Effect']) . "','" . mysql_real_escape_string($_POST['Card_Effect']) . "')";
