         ...
         if(statusTxt=="success")
            ...
            $("#card_text_info").ready(function() {
               ...
               $("button.add_cards_text_submit").on("click", function() {
                  ...
                  $("#card_text_info").load("new_cards_func.php", {add_cards_text_submit:"add_cards_text_submit", Text_Language:Text_Language, Materials:Materials, Pendulum_Effect:Pendulum_Effect, Card_Effect:Card_Effect, Flavor_Text:Flavor_Text}, function(responseTxt,statusTxt,xhr){
                     if(statusTxt=="success")
                        console.log("Success");
                        $("#card_text_info").ready(function() {
                           $("div.ygo_text").on("click", function() {
