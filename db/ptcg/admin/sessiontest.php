...
$temp = "woot";
   while($row2 = mysql_fetch_array($result2)){
      if($temp == $row2['Number']){
         ...
         $temp = $row2['Number'];
         //$newQuery = "UPDATE YGO_SET_EN SET DB_ID='" . $tempArray[$temp] . "' WHERE Number='" . $temp . "' AND Set_Name='Legacy of the Valiant'";
         $newQuery = "UPDATE YGO_SET_JP SET DB_ID='" . $tempArray[$temp] . "' WHERE Number='" . $temp . "' AND Set_Name='アドバンスド・トーナメントパック２０１４ Ｖｏｌ．２'";
