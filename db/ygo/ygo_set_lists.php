...
<?php
   ...
   for($j = 1; $j <= count($tempSetList); $j++){
      ...
      if($ed1Color == 2 || $ed2Color == 2){
         echo '<div class="Complete" id="aSet" >';
      }elseif($ed1Color == 1 || $ed2Color == 1){
         echo '<div class="Partial" id="aSet" style="';
...
echo 'filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="' . $haveSomeColor . '", endColorstr="' . $haveNoneColor . '",GradientType=1 ); /* IE6-9 */';
         ...
         echo '<div class="None" id="aSet">';
      }
      echo "<div id=\"setListNum\">" . $tempSetList[$j]['Set_Abb'] . " </div>";
      echo "<div id=\"setListName\">" . $tempSetList[$j]['Set_Name'] . " </div><br/>";
      ...
      echo '<input type="hidden" class="setName" name="setName" value="' . $tempSetList[$j]['Set_Name'] . '">';
         if($ed1Color == 1){
            echo '<button type="submit" value="Submit" class="blueButton"><i>';
         }elseif($ed1Color == 2){
            echo '<button type="submit" value="Submit" class="greenButton"><i>';  
         }else{
            echo '<button type="submit" value="Submit" class="noButton"><i>'; 
         }
...
echo 'filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="' . $haveSomeColor . '", endColorstr="' . $haveNoneColor . '",GradientType=1 ); /* IE6-9 */';
      ...
      echo "<div id=\"setListName\">" . $tempSetList[$j]['Set_Name'] . " </div><br/>";
         ...
         edition($tempSetList[$j]['Edition_2']);
         echo "</i> ";
